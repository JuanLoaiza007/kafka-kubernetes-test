...
k3d cluster create my-cluster -p "8000:30000@agent:1" -p "8001:30100@agent:2" -p "8002:30200@agent:3" -p "8003:30300@agent:4" -p "8004:30400@agent:5" -p "8006:30600@agent:7" --agents 8
